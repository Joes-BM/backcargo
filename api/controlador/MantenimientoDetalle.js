...
exports.getMantDetalleByIdMantenimiento = exports.posMantenimientoDetalle = void 0;
...
exports.getMantDetalleByIdMantenimiento = (req, res) => {
    Sequelize_1.MantenimientoDetalle.findAll({
        where: {
            mant_id: req.params.id
        }
    }).then((objetoVehiculo) => {
        res.status(200).json({
            mensaje: 'OK',
